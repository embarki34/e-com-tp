        ...
        <CardContent className="p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                <Input
                  ...
                  className="flex-grow"
                />
                <Button type="submit" variant="default" className="bg-blue-500 hover:bg-blue-600 text-white" disabled={isLoading}>
                  {isLoading ? (
                    <>
          ...
          {!isLoading && !order && !error && (
            <div className="bg-white rounded-lg p-6 shadow-sm h-96 flex items-center justify-center">
              <p className="text-gray-500 text-lg">Enter an order ID to track your order.</p>
            </div>
          )}
        </CardContent>
      </Card>
